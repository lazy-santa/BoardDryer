...
/* USER CODE BEGIN EV */
extern uint8_t Info_Mass_Index;
extern volatile uint8_t ButtonEncoder_State;
extern volatile uint8_t ButtonDoor_State;
uint8_t encValue = 0;
extern float Count_Timer;
extern float Count_CheckTimer;
/* USER CODE END EV */
